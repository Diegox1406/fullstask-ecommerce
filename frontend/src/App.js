...
const Contacto = () => <h1 style={{ paddingTop: "100px", textAlign: "center" }}>Contacto Page</h1>;
        ...
        <Router>
          <div className="App">
            ...
            <Routes>
              ...
              {/* 404 */}
              <Route path="*" element={<h1 style={{ paddingTop: "100px", textAlign: "center" }}>404: Página no encontrada</h1>} />
            </Routes>
            <Footer />
          </div>
        </Router>
